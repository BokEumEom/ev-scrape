  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-4">
        <h2 id="filter-bottom-sheet-title" className="text-lg font-semibold">충전소 찾기 😊</h2>
      </div>
      <div className="mb-6">
      ...
      <div className="flex justify-between gap-1">
        <button onClick={handleClose} className="px-4 py-2 w-1/2 border border-gray-300 text-gray-700 rounded">닫기</button>
        <button onClick={handleClose} className="px-4 py-2 w-1/2 bg-blue-500 text-white rounded">적용하기</button>
      </div>
    </motion.div>
  );
};
