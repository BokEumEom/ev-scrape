...
const DropdownMenu = ({ isOpen }) => {
  return isOpen ? (
    ...
    >
      <ul className="py-1">
        <li>
          <NavLink to="/community" className="block px-4 py-2 text-gray-800 hover:bg-gray-100" title="Community">
            <IoPeopleSharp className="inline-block mr-2" aria-label="Community" />
            커뮤니티
          </NavLink>
        </li>
        <li>
          <NavLink to="/vehiclespec" className="block px-4 py-2 text-gray-800 hover:bg-gray-100" title="Vehicle Specifications">
            <IoCarSportSharp className="inline-block mr-2" aria-label="Vehicle Specifications" />
            차량제원
          </NavLink>
        </li>
        <li>
          <NavLink to="/map" className="block px-4 py-2 text-gray-800 hover:bg-gray-100" title="Charging Stations">
            <FaChargingStation className="inline-block mr-2" aria-label="Charging Stations" />
            충전소
          </NavLink>
        </li>
        <li>
          <NavLink to="/game" className="block px-4 py-2 text-gray-800 hover:bg-gray-100" title="Charging Stations">
